...
function loadPostTableDataRecentUniverse(&$posts, $limit, $offset, $universeID) {
    ...
    if(!isAuthenticated()) {
        ...
        $stmt->bind_param("sssii", $currentSessionID, $universeID, $universeID, $limit, $offset);
    } else {
        $currentUserID = getCurrentUserID();
        $stmt->bind_param("sssii", $currentUserID, $universeID, $universeID, $limit, $offset);
    }
    $stmt->execute();
